        ...
        <div className="section-width">
          <div className="relative w-full rounded-3xl overflow-hidden aspect-square md:aspect-[21/9]">
            ...
            <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center pb-8 md:pb-12 px-6 text-center">
              <h1
                className="font-display text-3xl md:text-5xl font-semibold text-white leading-tight drop-shadow-md"
      ...
      <section className="pt-2 pb-6">
        <div className="section-width text-center">
          <p className="font-display text-xl md:text-3xl font-semibold text-black">
            {t.home.subheadline.pre}
            <span
              className="underline decoration-2 underline-offset-4"
              style={{ textDecorationColor: '#00B893' }}
            >
              {t.home.subheadline.highlight}
            </span>
          </p>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-8 text-center">
              ...
              <div className="flex items-center justify-center gap-2 mt-1">
                <p className="text-gray-500 text-sm">{t.home.quiz.hint}</p>
              ...
              >
                ...
                <div className="flex flex-col gap-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <p
                      className="text-gray-700 font-semibold pt-1.5"
                      dangerouslySetInnerHTML={{ __html: t.home.whyDifferent.points[0] }}
                    />
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-9 h-9 flex-shrink-0 bg-white">
                    ...
                    <p
                      className="text-gray-700 font-semibold pt-1.5"
                      dangerouslySetInnerHTML={{ __html: t.home.whyDifferent.points[1] }}
                    />
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-9 h-9 flex-shrink-0 bg-white">
                    ...
                    <p
                      className="text-gray-700 font-semibold pt-1.5"
                      dangerouslySetInnerHTML={{ __html: t.home.whyDifferent.points[2] }}
                    />
                  </div>
                </div>
                <button onClick={() => scrollToQuiz('Warum anders')} className="btn-primary w-fit">
                  {t.home.whyDifferent.cta} <ArrowRight size={18} />
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                <button onClick={() => scrollToQuiz('Standort')} className="btn-primary w-fit">
                  {t.home.location.cta} <ArrowRight size={16} />
                </button>
              </div>
            </div>
          ...
          <div className="rounded-3xl overflow-hidden">
            <div className="grid md:grid-cols-3">
              ...
              >
                ...
                >
                  {t.home.finalCta.cta} <ArrowRight size={18} />
                </button>
              </div>
            </div>
          </div>
